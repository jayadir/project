...
export default function Slides() {
  return (
    <div id="slide" className="carousel slide" data-bs-ride="carousel" style={{"objectFit":"contain important"}}>
  <div className="carousel-indicators">
    <button type="button" data-bs-target="#slide" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1"></button>
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/f1.png" className="d-block w-100" alt="..."/>
